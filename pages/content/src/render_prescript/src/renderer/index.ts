...
import { FunctionInfo, Parameter, ParamValueElement } from '../core/types';
...
const updateParameters = (
    ...
    for (const param of parameters) {
        ...
        let paramRow = paramContainer.querySelector(`.param-row[data-param-name="${param.name}"]`) as HTMLElement;
        if (!paramRow) {
